...
{
	if (intersect != null) {
		if (intersect.object.userData.events !== undefined && intersect.object.userData.events.click !== undefined) {
			for (var key in intersect.object.userData.events.click) {
				var func = intersect.object.userData.events.click[key];
				switch (func.name) {
					case "changeBubble":
						actionChangeBubble(func.id);
						break;
				}
			}
		}
